  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
        <h2 className="text-2xl font-bold text-center text-gray-800">SaaS Notes Login</h2>
        ...
        <div className="p-4 mt-4 text-sm bg-gray-50 rounded-md">
            <h4 className="font-bold">Test Accounts (password: password)</h4>
